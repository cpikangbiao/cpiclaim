...
/**
 * Test class for the CaseRecoveryBillResource REST controller.
 *
 * @see CaseRecoveryBillResource
 */
@RunWith(SpringRunner.class)
@SpringBootTest(classes = {SecurityBeanOverrideConfiguration.class, CpiclaimApp.class})
public class CaseRecoveryBillResourceIntTest {
    ...
    public void getAllCaseRecoveryBillsByCaseRecoveryIsEqualToSomething() throws Exception {
        // Initialize the database
        CaseRecovery caseRecovery = CaseRecoveryResourceIntTest.createEntity(em);
