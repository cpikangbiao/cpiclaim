...
/**
 * Test class for the CaseRegisterLogResource REST controller.
 *
 * @see CaseRegisterLogResource
 */
@RunWith(SpringRunner.class)
@SpringBootTest(classes = {SecurityBeanOverrideConfiguration.class, CpiclaimApp.class})
public class CaseRegisterLogResourceIntTest {
    ...
    private static final String DEFAULT_ASSIGN_TIME = "AAAAAAAAAA";
    private static final String UPDATED_ASSIGN_TIME = "BBBBBBBBBB";
