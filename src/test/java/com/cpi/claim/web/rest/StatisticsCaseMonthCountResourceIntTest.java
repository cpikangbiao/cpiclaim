...
/**
 * Test class for the StatisticsCaseMonthCountResource REST controller.
 *
 * @see StatisticsCaseMonthCountResource
 */
@RunWith(SpringRunner.class)
@SpringBootTest(classes = {SecurityBeanOverrideConfiguration.class, CpiclaimApp.class})
public class StatisticsCaseMonthCountResourceIntTest {
