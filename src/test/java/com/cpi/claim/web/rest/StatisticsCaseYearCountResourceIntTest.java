...
/**
 * Test class for the StatisticsCaseYearCountResource REST controller.
 *
 * @see StatisticsCaseYearCountResource
 */
@RunWith(SpringRunner.class)
@SpringBootTest(classes = {SecurityBeanOverrideConfiguration.class, CpiclaimApp.class})
public class StatisticsCaseYearCountResourceIntTest {
